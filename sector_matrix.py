...
# 2026-09-14 KRX 매매거래시간 연장 시행: 정규장(09:00~15:30)은 그대로, 애프터마켓이
# 16:00~20:00 로 늘면서 실시간 접속매매로 바뀜(기존 10분 단일가). 프리마켓(07:00~07:50)은
# 이 프로젝트 범위 밖이라 아직 미포함. 두 세션의 시작·끝 시각을 여기 한 곳만 고치면
# 슬롯 라벨·수집 스케줄·프론트 "장중" 배지가 전부 따라감.
