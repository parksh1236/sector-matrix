...
> **거래시간(2026-09-14 KRX 매매거래시간 연장 시행)**: 정규장 09:00~15:30은 그대로,
> 애프터마켓이 16:00~20:00로 늘면서 정규장과 같은 실시간 접속매매로 바뀝니다(기존 10분 단일가).
> 이 프로젝트는 정규장+애프터마켓을 09~20시(사이 휴장) 한 스케줄로 취급합니다.
